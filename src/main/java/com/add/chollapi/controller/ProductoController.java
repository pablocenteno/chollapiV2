...
public class ProductoController {
    ...
    public ResponseEntity<String> crearProducto(@RequestBody Producto producto) {
        ...
        return ResponseEntity.status(HttpStatus.OK).header("Content-Type", "application/json").body(productoService.crearProducto(producto).toString());
    }
    ...
    public ResponseEntity<String > modificarProducto(@RequestBody Producto producto) {
        return ResponseEntity.status(HttpStatus.OK).header("Content-Type", "application/json").body(productoService.modificarProducto(producto).toString());
    }
    @RequestMapping(method = RequestMethod.DELETE, value ={"/producto"})
    public ResponseEntity<Boolean> borrarProducto(@RequestBody Long idProducto) {
